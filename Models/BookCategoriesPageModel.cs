...
namespace Peia_CarmenDenisa_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Peia_CarmenDenisa_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Peia_CarmenDenisa_Lab8Context context,
